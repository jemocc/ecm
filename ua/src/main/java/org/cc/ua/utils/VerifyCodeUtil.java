...
public class VerifyCodeUtil {
    ...
    public static final String VERIFY_CODES = "ABC2DEF3GHJ4KLM5NPQ6RST7UVW8XYZ9";
    ...
    public static void outputImage(int w, int h, OutputStream os, String code) throws IOException {
        ...
        // 添加噪点
        float saltRate = 0.05f;// 噪声率
        int area = (int) (saltRate * w * h);
        ...
        for(int i = 0; i < verifySize; i++){
            ...
            affine.setToRotation(Math.PI / 4 * random.nextDouble() * (random.nextBoolean() ? 1 : -1), ((double) w / verifySize) * i + (double) fontSize/2, (double) h/2);
